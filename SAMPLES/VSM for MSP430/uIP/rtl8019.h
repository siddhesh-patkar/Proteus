...
#define RTL8019_ADDRESS_PORT        P2OUT
#define RTL8019_ADDRESS_DDR         P2DIR
#define RTL8019_ADDRESS_MASK        0x1F

// RTL8019 data port
#define RTL8019_DATA_PORT           P5OUT
#define RTL8019_DATA_DDR            P5DIR
#define RTL8019_DATA_PIN            P5IN

// RTL8019 control port
#define RTL8019_CONTROL_PORT        P4OUT
#define RTL8019_CONTROL_DDR         P4DIR
#define RTL8019_CONTROL_READPIN     0
#define RTL8019_CONTROL_WRITEPIN    1

#endif /** NIC Interface **/

// RTL8019 RESET pin
#define RTL8019_RESET_PORT 	      P1OUT
#define RTL8019_RESET_DDR 	         P1DIR
