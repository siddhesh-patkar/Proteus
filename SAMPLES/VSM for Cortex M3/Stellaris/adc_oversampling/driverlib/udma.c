...
//! to this function, then the secondary peripheral (marked as _SEC_)
//! will be selected.
//!
...
//! - UDMA_DEF_EMACRX_SEC_TMR2A
//! - UDMA_DEF_EMACTX_SEC_TMR2B
//! - UDMA_DEF_UART0RX_SEC_UART1RX
//! - UDMA_DEF_UART0TX_SEC_UART1TX
//! - UDMA_DEF_SSI0RX_SEC_SSI1RX
//! - UDMA_DEF_SSI0TX_SEC_SSI1RX
//! - UDMA_DEF_CAN0RX_SEC_UART2RX
//! - UDMA_DEF_CAN0TX_SEC_UART2TX
...
//! - UDMA_DEF_TMR1A_SEC_GPIORX
//! - UDMA_DEF_TMR1B_SEC_GPIOTX
//! - UDMA_DEF_UART1RX_SEC_CAN2RX
//! - UDMA_DEF_UART1TX_SEC_CAN2TX
//! - UDMA_DEF_SSI1RX_SEC_ADC10
//! - UDMA_DEF_SSI1TX_SEC_ADC11
//! - UDMA_DEF_CAN1RX_SEC_ADC12
//! - UDMA_DEF_CAN1TX_SEC_ADC13
//! - UDMA_DEF_I2S0RX_SEC_CAN1RX
//! - UDMA_DEF_I2S0TX_SEC_CAN1TX
//!
//! \return None.
//
//*****************************************************************************
...
//! following macros.  If one of the macros below is in the list passed
//! to this function, then the default peripheral (marked as _DEF_)
//! will be selected.
//!
//! - UDMA_DEF_USBEP1RX_SEC_UART2RX
//! - UDMA_DEF_USBEP1TX_SEC_UART2TX
