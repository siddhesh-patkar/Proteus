...
#if TARGET==6811 || TARGET==103
#define ZPAGE zpage
#elif TARGET==8051
#define ZPAGE __idata
#else
#define ZPAGE 
#endif
...
extern ZPAGE INT8  rate;
extern ZPAGE INT8  piecerate;
...
#define is_opp_piece(r,c,p) (((board[r][c] & 0x08) ^ (p & 0x08)) && (board[r][c]))
