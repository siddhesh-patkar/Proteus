...
void Adafruit_INA219::begin(uint8_t addr) {
  ina219_i2caddr = addr | INA219_ADDRESS;
  ina219_currentDivider_mA = 0;
  ina219_powerDivider_mW = 0;
  begin();
}
...
/**************************************************/ 
/*** New functions we wrote as they were not    ***/ 
/*** available with original Adafruit drivers.  ***/
/**************************************************/

// Get Power from register #3. 
int16_t Adafruit_INA219::getPower_raw() 
 { uint16_t value;
   // Write calibration value to calibration register,
   // otherwise power result will be unavailable.
   wireWriteRegister(INA219_REG_CALIBRATION, ina219_calValue);
...
float  Adafruit_INA219::getPower_mW()
 { float valueDec = getPower_raw();
   // Power Register content is multiplied by Power LSB which 
   // is 20 times the Current_LSB for a power value in watts.
