...
// Added to retrieve the calibration coefficients. 
// The parameter coeffIdx is the index in the coefficient table such that coeffIdx=0 is AC1, coeffIdx=1 ia AC2 and so on. 
float Adafruit_BMP085::getCalibrationCoeff (uint8_t coeffIdx)
 { switch (coeffIdx)
    { case 0:  return (int16_t)  ac1; break;
      case 1:  return (int16_t)  ac2; break;
      case 2:  return (int16_t)  ac3; break;
      case 3:  return (uint16_t) ac4; break;
      case 4:  return (uint16_t) ac5; break;
      case 5:  return (uint16_t) ac6; break;
      case 6:  return (int16_t)  b1;  break;
      case 7:  return (int16_t)  b2;  break;
      case 8:  return (int16_t)  mb;  break;
      case 9:  return (int16_t)  mc;  break;
      case 10: return (int16_t)  md;  break;
      default: return 0;
    }
 } 
