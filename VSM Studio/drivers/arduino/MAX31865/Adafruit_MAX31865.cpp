...
boolean Adafruit_MAX31865::begin(/*max31865_numwires_t*/ int8_t wires) {
  pinMode(_cs, OUTPUT);
...
void Adafruit_MAX31865::setWires(/*max31865_numwires_t*/ int8_t wires ) {
  uint8_t t = readRegister8(MAX31856_CONFIG_REG);
...
// Added resistance value in Ohms normalized to 100 Ohms. Not present in Adafruit original drivers.
float  Adafruit_MAX31865::resistance(float RTDnominal, float refResistor) {
   float Rt;
