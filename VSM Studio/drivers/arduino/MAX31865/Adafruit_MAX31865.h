...
class Adafruit_MAX31865 {
 public:
  ...
  boolean begin(/*max31865_numwires_t*/ int8_t x = MAX31865_2WIRE);
  ...
  void setWires(/*max31865_numwires_t*/ int8_t wires);
  void autoConvert(boolean b);
  void enableBias(boolean b);

  float temperature(float RTDnominal, float refResistor);
  float resistance (float RTDnominal, float refResistor);
